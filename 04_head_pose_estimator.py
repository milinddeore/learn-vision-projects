#
# Let us say you have 2D image and you would like to find out its 3D model,
# because when you have 3D model you can calculate rotation vector. This example
# is all about transforming 2D image to 3D space. This is achieved using opencv
# function solvePnP().
#
...
def get_head_pose(shape, frame):
    ...
    reprojectdst, _ = cv2.projectPoints(reprojectsrc, rotation_vec, translation_vec,
            camera_matrix,dist_coeffs)
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            if len(face_rects) > 0:
                ...
                reprojectdst, euler_angle = get_head_pose(shape, frame)
